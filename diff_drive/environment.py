...
class Environment(Node):
    def __init__(self, throttleSize=4, steerSize=9, traj_num = 0, collectFlag = False, model='dqn', vehicleNum=1):
        ...
        self.acceleration = self.get_parameter('f_wheel_friction_mu').get_parameter_value().double_value
        self.declare_parameter('f_wheel_friction_mu2', 0.01)
        self.acceleration = self.get_parameter('f_wheel_friction_mu2'
                                               ).get_parameter_value().double_value
        self.declare_parameter('r_wheel_friction_mu', 0.01)
        self.acceleration = self.get_parameter('r_wheel_friction_mu').get_parameter_value().double_value

        self.declare_parameter('r_wheel_friction_mu2', 0.01)
        self.acceleration = self.get_parameter('r_wheel_friction_mu2').get_parameter_value().double_value
